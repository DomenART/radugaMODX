<header class="header">
	<ul class="header-social">
		<li>
			<a href="{'site.vk' | url}" aria-label="Страница Вконтакте">
		...
		<li>
			<a href="{'site.instagram' | url}" aria-label="Профиль в инстаграме">
		...
		<li>
			<a href="{'site.youtube' | url}" aria-label="Канал на ютубе">
	...
	<a href="mailto:{'site.email' | config}" class="header__email" title="Электронная почта">{'site.email' | config}</a>
